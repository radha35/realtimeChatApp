...
function MessageArea() {
  ...
  return (
    <div className={`lg:w-[70%]  relative ${selectedUser?"flex":"hidden"} lg:flex  w-full h-full bg-slate-200 border-2 border-gray-300`}>
      {selectedUser &&
      ...
      <div className="w-full h-[100px] bg-[#1797c2] rounded-b-[30px] shadow-gray-400 shadow-lg gap-[20px] flex  items-center px-[20px]">
        ...
        <div
          className="w-[50px] h-[50px] rounded-full overflow-hidden flex justify-center bg-white cursor-pointer items-center shadow-gray-600 shadow-lg">
          <img src={ selectedUser?.image || dp} alt="" className="h-[100%]" />
        </div>
         <h1 className='text-white font-semibold text-[18px]'>{selectedUser?.name || "user"}</h1>
      </div>
      ...
      <div className="w-full h-[70%] flex flex-col py-[30px] px-[20px] overflow-auto gap-[20px] ">
       ...
       <div className="w-full h-full flex flex-col justify-center items-center">
          <h1 className='text-gray-700 font-bold text-[50px]'>Welcome to ConvoBuddy 🫂 </h1>
        ...
        {selectedUser &&  <div className="w-full lg:w-[70%] h-[100px] fixed bottom-[20px] flex items-center justify-center ">
           <img src={frontendImage} alt="" className="w-[80px] absolute bottom-[100px] right-[20%] rounded-lg shadow-gray-500 shadow-lg"/>
         <form className="w-[95%] lg:w-[70%] h-[60px] bg-[rgb(23,151,194)] shadow-gary-500 shadow-lg rounded-full flex items-center gap-[20px] px-[20px]" onSubmit={handleSendMessage}>
